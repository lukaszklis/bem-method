...
Чтобы получить из отдельных файлов технологий общие файлы для всего проекта (бандлы) используется сборка. Для этого можно применить любой из [инструментов](#Инструменты-для-сборки).
