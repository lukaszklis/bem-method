...
Чтобы в результате сборки получить веб-страницу необходимо:
...
В БЭМ-методологии блоки могут строиться на основании других блоков. Для этого необходимо описать зависимости от них.
